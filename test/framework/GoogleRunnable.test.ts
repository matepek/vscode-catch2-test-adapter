...
describe(pathlib.basename(__filename), function () {
  ...
  context('_reloadFromString', function () {
    it('should reload ex.1', async function () {
      ...
      assert.strictEqual(tests[11].getStaticEvent('1'), undefined);
      ...
      assert.strictEqual(tests[12].getStaticEvent('1'), undefined);
      ...
      assert.strictEqual(tests[13].getStaticEvent('1'), undefined);
