...
**This is the previous version of the [extension](https://github.com/matepek/vscode-catch2-test-adapter). It is published in case someone has developed serious feelings for it (or the new version is too buggy currently (I'm working on it)).**

This extension is built upon [Test Explorer for Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=hbenl.vscode-test-explorer)
but VSCode has publised a new testing API which opens the possiblility for new features. That's why this version is kinda frozen.

## A **Catch2**, **GoogleTest**, **doctest** and **GoogleBenchmark** Explorer for VSCode

[![Visual Studio Marketplace](https://img.shields.io/vscode-marketplace/v/matepek.testmate-cpp-legacy.svg)](https://marketplace.visualstudio.com/items?itemName=matepek.testmate-cpp-legacy)
...
[![Visual Studio Marketplace](https://img.shields.io/vscode-marketplace/d/matepek.testmate-cpp-legacy.svg)](https://marketplace.visualstudio.com/items?itemName=matepek.testmate-cpp-legacy)
...
- Grouping can be fully customized. ([Details](https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/documents/configuration/test.advancedExecutables.md#testgrouping))
...
## [Configuration](https://github.com/matepek/vscode-catch2-test-adapter/tree/legacy/documents/configuration)

[settings.json]: https://code.visualstudio.com/docs/getstarted/settings
[test.advancedexecutables]: https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/documents/configuration/test.advancedExecutables.md
[debug.configtemplate]: https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/documents/configuration/debug.configTemplate.md
...
## About [Sentry.io](https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/documents/configuration/log.logSentry.md) integration

## [License](https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/LICENSE)

## [Support](https://github.com/matepek/vscode-catch2-test-adapter/blob/legacy/documents/support.md)
