...
| `catch2TestExplorer.googletest.treatGmockWarningAs` | Forces the test to be failed even it is passed if contains the string `GMOCK_WARNING:`. (You may should consider using `testing::StrictMock<T>`)                                                                                                                                                                         |
