...
| `coverage.profile.default`                | In case multiple Coverage profiles were registered though API, one can set the default with this option by its _ID_. UI can override this selection, this is just a default.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
