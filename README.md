...
- Runs executables parallel (_copper.test.parallelExecutionLimit_).
...
- Grouping can be fully customized. ([Details](https://github.com/matepek/vscode-catch2-test-adapter/blob/master/documents/configuration/test.executables.md#testgrouping))
...
[test.executables]: https://github.com/matepek/vscode-catch2-test-adapter/blob/master/documents/configuration/test.executables.md
...
Not good enough for you?!: Edit your `.vscode/`[settings.json] file according to the [test.executables]!

| `copper.___`                      | Description                                                                                                                                                                                                                                                                                                                                                          |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `test.executable`                 | The location of your test executable (relative to the workspace folder or absolute path). Empty string means disabled. For more option set [copper.test.executables](https://github.com/matepek/vscode-catch2-test-adapter/blob/master/documents/configuration/test.executables.md) instead of this. NOTE: if `copper.test.executables` is set then this is ignored. |
| [test.executables]                | Array of executables with a lot of options. (If this is set then `copper.test.executable` is ignored.) ([Details](https://github.com/matepek/vscode-catch2-test-adapter/blob/master/documents/configuration/test.executables.md)).                                                                                                                                   |
...
Plenty of more **fine-tuning options** are available under [test.executables] like:
