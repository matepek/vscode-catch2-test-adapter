...
describe(path.basename(__filename), function() {
  it('package.json: executables should be consistent', function() {
    ...
    const packageJson = fse.readJSONSync(path.join(settings.workspaceFolderUri.fsPath, '../..', 'package.json'));
  ...
  it('package.json should be consistent with README.md', function() {
    ...
    const readme = fse.readFileSync(path.join(settings.workspaceFolderUri.fsPath, '../..', 'README.md')).toString();
