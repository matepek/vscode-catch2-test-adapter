...
export abstract class AbstractRunnable {
  ...
  protected _findFilePath(matchedPath: string): string {
    ...
    if (this.properties.options.cwd && !this.properties.path.startsWith(this.properties.options.cwd.toString()))
      directoriesToCheck.push(this.properties.options.cwd.toString());

    if (
      !this.properties.path.startsWith(this._shared.workspaceFolder.uri.fsPath) &&
      (!this.properties.options.cwd ||
        !this.properties.options.cwd.toString().startsWith(this._shared.workspaceFolder.uri.fsPath))
    )
