...
| `${workspaceFolder}`         | Path to the current workspace folder. In multi-root workspaces, use `${workspaceFolder:workspaceName}` to reference a specific workspace folder by name. |
